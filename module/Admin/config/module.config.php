...
return array(
    'service_manager' => array(
        'invokables' => array(
            ...
            'Admin\Model\NoticiaModel'          => 'Admin\Model\NoticiaModel',
            ...
            'Admin\Model\LogModel'              => 'Admin\Model\LogModel',
            'Admin\Model\PostModel'             => 'Admin\Model\PostModel',
            'Admin\Model\CommentModel'          => 'Admin\Model\CommentModel',
        )
    ),
    'controllers' => array(
        'invokables' => array(
            ...
            'Admin\Controller\PerfisCursos'       => 'Admin\Controller\PerfisCursosController',
                ...
                'pages' => array(
                    array(
                        ...
                        'pages' => array(
                            ...
                            array(
                                'label' => 'Perfis Cursos',
                                'controller' => 'perfiscursos',
                                'action' => 'index',
                                'pages' => array(
                                    array(
                                        'label' => 'Gerenciar perfis do usuário',
                                        'controller' => 'perfiscursos',
                                        'action' => 'gerenciarperfiscurso',
                                    ),
                                )
                            ),
                        )
